...
const ArtistComponent = () => {
    ...
    const updateArtist = () => {
        BackendService.updateArtist(artist)
            ...
            .catch((error) => {
                console.error('Ошибка при обновлении художник:', error);
                setShowAlert(true);
            });
    };
    ...
    return (
        <div className="m-4">
            ...
            <div className="row my-2">
                ...
                <div className="col">
                    <label htmlFor="name">Возраст художник:</label>
                    <input
                        type="number"
                        id="age"
                        name="age"
            ...
            <Alert
                title="Ошибка"
                message="Произошла ошибка при обновлении художник."
                ok={closeAlert}
                close={closeAlert}
                modal={showAlert}
            />
